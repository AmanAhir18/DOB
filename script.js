...
function ageCalculate() {
  ...
  birthHours = currentHours;
  birthMinutes = currentMinutes;
  birthSeconds = currentSeconds;
...
function startAgeTimer() {
  ageCalculate(); // Calculate age initially
  ageTimer = setInterval(ageCalculate, 1000); // Update age every second
}

function stopAgeTimer() {
  clearInterval(ageTimer); // Stop the age update timer
}
